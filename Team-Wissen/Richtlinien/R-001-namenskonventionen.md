...
1. **Englisch oder Deutsch — konsequent pro Bereich.** Standardordner sind deutsch (`01-Wissen/`, `03-Kunden/`). System-Bereiche sind englisch (`Team/`, `.claude/`).
...
- **Hauptordner:** Nummer-Prefix für Reihenfolge. `00-Posteingang`, `01-Wissen`, etc.
- **Spezialisten-Ordner:** Format `<Name> - <Rolle>/`. Beispiel: `Larry - Orchestrator/`. Mit Bindestrich-Leerzeichen.
- **Kunden:** kebab-case ohne Rechtsform-Suffix. `acme/` statt `acme-gmbh/`. Status im Frontmatter, nicht im Foldername.
- **Mitarbeiter:** kebab-case `vorname-nachname/`. Kein Komma, keine Titel.

## Dateien nach Typ

| Typ | Format | Beispiel |
|---|---|---|
| Hub-Datei | `_hub.md` | `03-Kunden/acme/_hub.md` |
| INDEX | `INDEX.md` | `Team-Wissen/SOPs/INDEX.md` |
| README | `README.md` | `00-Posteingang/README.md` |
| AGENTS-Vertrag | `AGENTS.md` | `Team/Larry - Orchestrator/AGENTS.md` |
...
| Briefing | `briefing.md` (im Kunden-Ordner) | `03-Kunden/acme/briefing.md` |
| Notizen | `notizen.md` (im Kunden-Ordner) | `03-Kunden/acme/notizen.md` |
...
- ❌ Dateien mit Umlaut/Leerzeichen → Larry benennt um, wenn keine externen Links betroffen sind, sonst flagged
