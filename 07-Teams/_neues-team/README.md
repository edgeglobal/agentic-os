...
**`vorlagen/`:** Output-Templates die nur dieses Team nutzt. Vertriebs-Vorlage liegt **nicht** in `02-Vorlagen/` (firmenweit), sondern hier.
...
- **Firmenweite Vorlagen** (z.B. Meeting-Protokoll) → `02-Vorlagen/`
- **Firmenweite Projekte mit mehreren Teams** → `05-Projekte/`
- **Meetings** (intern und extern) → `08-Meetings/`
